...
<div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
                ...
                <div class="row row-sm">
                    ...
                    <div class="col-lg-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="Username" name ="name" value ="{{ $user->name }}"
                    ...
                    <div class="col-lg-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="email" class="form-control" aria-label="email"
                                aria-describedby="email" name="email" value="{{ $user->email }}" required autofocus autocomplete="email" />
                        </div>
                        <!-- input-group -->
                    </div>
                    <!-- col -->
                    ...
                    <div class="col-lg-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="Position"
                                aria-describedby="position" name="position" value="{{ $user->position}}" />
                        </div>
                        <!-- input-group -->
                    </div>
 ...
 @section('validator')
{!! JsValidator::formRequest('App\Http\Requests\UserUpdateRequest','#edit-user-form') !!}
@endsection
